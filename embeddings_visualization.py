...
cifar100_labels = {
    ...
    61: "plate",    62: "poppy",    63: "porcupine",    64: "possum",    65: "rabbit",    66: "raccoon",    67: "ray",    68: "road",    69: "rocket",    70: "rose",    71: "sea",
    72: "seal",    73: "shark",    74: "shrew",    75: "skunk",    76: "skyscraper",    77: "snail",    78: "snake",    79: "spider",    80: "squirrel",    81: "streetcar",
    82: "sunflower",    83: "sweet_pepper",    84: "table",    85: "tank",    86: "telephone",    87: "television",    88: "tiger",    89: "tractor",    90: "train",
...
def create_tsne_visualization(model, test_loader, num_classes, class_names, out_file,batch_extractor,device):
    ...
    for class_label in trange(num_classes,desc='Label'):
...
if __name__ == "__main__":
    ...
    if args.dataset == 'CUB200':
        datamodule = CUB200DataModule(batch_size=2)
        ...
        dataset = torchvision.datasets.CIFAR100(root='dataset/cifar',download=True,train=False,transform=torchvision.transforms.Compose([
